...
#SBATCH --output=/nas-ctm01/homes/pferreira/Cinderella_Pedro/results/DaViT_Tiny.out
#SBATCH --error=/nas-ctm01/homes/pferreira/Cinderella_Pedro/results/DaViT_Tiny.err
